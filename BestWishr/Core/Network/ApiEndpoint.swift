...
enum ApiEndpoint {
    ...
    private var method: String {
        switch self {
        case .authLogin, .authRegister, .authVerifyEmail, .authSendEmailVerification, .authLogout, .authForgotPassword, .authResetPassword, .appleAuth, .authSocialMobile: return "POST"
        }
    }
